               ...
               <div className="flex flex-col md:flex-row items-end justify-between gap-8">
                  <div className="max-w-3xl">
                     ...
                     <h1 className="text-4xl md:text-6xl font-black font-display leading-tight mb-6">
                        GRP Material Science <br /><span className="text-white">Built for Site Realities.</span>
                     </h1>
                     <p className="text-gray-400 text-lg font-light leading-relaxed max-w-2xl font-sans">
                        GRP (Glass Reinforced Plastic) is a practical choice for sites where steel corrodes and concrete cracks. We focus on material performance in rain, coastal humidity, and industrial heat.
                     </p>
                  </div>
               ...
               <div className="animate-fade-in space-y-16">
                     ...
                     <table className="w-full min-w-[800px] text-sm">
                        ...
                        <tbody className="divide-y divide-gray-100">
                           {[
                              ...
                              { prop: 'Maintenance Req.', grp: 'No repainting', ms: 'Regular Painting', ss: 'Periodic Cleaning' },
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                     <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex flex-col items-center text-center">
                        ...
                        <h4 className="font-bold text-lg mb-2">Easier to Handle</h4>
                        <p className="text-sm text-gray-600">GRP is 1/4th the weight of steel. This makes it easier for 2 workers to carry and mount an enclosure without needing a crane or heavy hoist.</p>
                     </div>
                     <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex flex-col items-center text-center">
                        <ShieldCheck className="w-10 h-10 text-emphz-navy mb-4" />
                        <h4 className="font-bold text-lg mb-2">Shock Proof Body</h4>
                        <p className="text-sm text-gray-600">Since GRP is an insulator, the body of the cabinet will not become live even if there is an internal wiring fault. This is safer for site workers.</p>
                     </div>
                     <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex flex-col items-center text-center">
                        <AlertTriangle className="w-10 h-10 text-emphz-navy mb-4" />
                        <h4 className="font-bold text-lg mb-2">Theft Prevention</h4>
                        <p className="text-sm text-gray-600">Unlike steel or aluminum which are often stolen for scrap value, GRP has no scrap resale value, making it safer from theft at remote sites.</p>
                     </div>
                  </div>
               </div>
            )}
               ...
               <div className="animate-fade-in">
                  <div className="flex flex-col lg:flex-row gap-16 items-center">
                     <div className="lg:w-1/2">
                        <div className="bg-emphz-teal/10 inline-block px-4 py-1 rounded-full text-emphz-teal font-bold text-xs uppercase tracking-widest mb-4">Cost Comparison</div>
                        <h2 className="text-3xl md:text-4xl font-black text-emphz-navy mb-6 font-display">Initial Price vs Total Cost.</h2>
                        <p className="text-lg text-gray-600 leading-relaxed mb-6 font-light">
                           Steel boxes are often chosen because their entry price is low. But in a coastal area or outdoor site, you will spend significantly on repainting and eventually replacing them within a few years.
                        </p>
                        <p className="text-lg text-gray-600 leading-relaxed mb-8 font-light">
                           A GRP unit may cost 15-20% more on day one, but it does not require rust-proofing or yearly painting. Typically, the total cost spent on GRP becomes lower than steel within just 3 years.
                        </p>
