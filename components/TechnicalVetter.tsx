        ...
        <div className="flex flex-col lg:flex-row gap-20 items-stretch">
          ...
          <div className="lg:w-1/3 flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-8">
               ...
               <span className="font-mono text-emphz-teal text-[10px] font-bold tracking-[0.4em] uppercase">GRP_VETTING_NODE_V2.4</span>
            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                               {ENVS.map(e => (
                                 <button 
                                   key={e.id}
                                   onClick={() => setEnv(e.id)}
                                   className={`flex items-center gap-8 p-10 rounded-3xl border text-left transition-all duration-500 ${env === e.id ? 'bg-emphz-teal border-emphz-teal shadow-2xl shadow-emphz-teal/20' : 'bg-white/5 border-white/5 hover:border-white/20'}`}
                                 >
                          ...
                          <div className="h-full">
                             ...
                             <div className="flex flex-col md:flex-row gap-4">
                                ...
                                <button 
                                  ...
                                  className={`flex-grow py-5 rounded-full font-bold text-[10px] uppercase tracking-[0.4em] transition-all shadow-2xl ${
                                    quoteItems.includes(configId) 
