        ...
        <div className="p-8 bg-emphz-dark border-b border-white/10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-mono text-neutral-500 uppercase tracking-widest">{items.length} Specifications Selected</p>
            </div>
          </div>
        ...
        <div className="flex-grow overflow-y-auto p-8 space-y-4 custom-scrollbar">
          {items.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center opacity-40">
              <FileText className="w-16 h-16 mb-6 text-neutral-600" strokeWidth={1} />
              <p className="text-xs font-mono uppercase tracking-[0.3em]">REQUISITION_EMPTY</p>
              <p className="text-[10px] text-neutral-500 mt-2 max-w-[200px]">Browse our ecosystems to add technical specs to your enquiry.</p>
            </div>
          ) : (
            items.map((item, idx) => (
              <div key={idx} className="group p-6 bg-white/[0.03] border border-white/5 rounded-2xl hover:border-emphz-teal/30 transition-all flex justify-between items-center">
                <div className="flex items-center gap-4">
                   ...
                   <div>
                      ...
                      <p className="text-[9px] font-mono text-neutral-500 uppercase tracking-widest">VERIFIED_SPEC_2024</p>
                   </div>
                </div>
                <button 
        ...
        {items.length > 0 && (
          <div className="p-8 bg-emphz-dark border-t border-white/10">
            <div className="flex items-center gap-3 mb-8 p-4 bg-white/5 border border-white/5 rounded-xl">
               ...
               <p className="text-[9px] font-mono text-neutral-400 uppercase leading-relaxed">System-calculated shipping density optimized for flat-pack deployment.</p>
            </div>
