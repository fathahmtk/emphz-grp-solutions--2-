...
import { ArrowRight, Send, Globe, ShieldCheck, Activity } from 'lucide-react';
           ...
           <div className="relative z-10 flex flex-col lg:flex-row gap-20 items-center justify-between">
              <div className="lg:w-3/5">
                 ...
                 <div className="flex flex-wrap gap-8 pt-10 border-t border-white/10">
                    <div className="flex items-center gap-3">
                       ...
                       <span className="text-[10px] font-mono text-slate-500 uppercase tracking-widest font-bold">Class-A Vendor Certified</span>
                    </div>
                    <div className="flex items-center gap-3">
                       <Activity className="w-5 h-5 text-emphz-teal" />
                       <span className="text-[10px] font-mono text-slate-500 uppercase tracking-widest font-bold">24h Technical Response</span>
                    </div>
                 </div>
              </div>
              ...
              <div className="lg:w-2/5 w-full">
                 <div className="bg-white p-12 md:p-16 rounded-[3.5rem] shadow-2xl transform group-hover:-translate-y-2 transition-all duration-700">
                    ...
                    <p className="text-slate-500 mb-10 font-light">Enter your corporate email to receive our 2024 Technical Compendium.</p>
                    ...
                    <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                       <div className="relative">
                          <input 
                            ...
                            className="w-full bg-slate-50 border border-slate-200 rounded-full px-8 py-5 text-sm font-bold text-emphz-darker focus:outline-none focus:border-emphz-teal transition-all uppercase tracking-widest placeholder:text-slate-300" 
                          />
                       </div>
                    ...
                    <div className="mt-8 flex items-center justify-center gap-4">
                       ...
                       <p className="text-[9px] font-mono text-slate-400 uppercase font-bold tracking-widest">Project Desk Active</p>
                    </div>
                 </div>
              </div>
           </div>
