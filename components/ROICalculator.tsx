...
import { TrendingUp, ShieldCheck, Activity, ArrowRight } from 'lucide-react';
...
const ROICalculator: React.FC = () => {
  ...
  return (
    <section id="roi" className="py-24 md:py-32 bg-neutral-50 border-t border-neutral-100 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-20 items-stretch">
            ...
            <div className="space-y-12 mb-12">
              <div className="group">
                <div className="flex justify-between items-center mb-6">
                  <label className="text-[10px] font-mono text-neutral-400 uppercase tracking-[0.3em] font-bold">Project Scale (Units)</label>
                  <span className="text-2xl font-bold text-emphz-blue">{units}</span>
                </div>
                <input
                  type="range" min="1" max="500" value={units}
                  onChange={(e) => setUnits(parseInt(e.target.value))}
                  className="w-full h-1.5 bg-neutral-200 appearance-none cursor-pointer accent-emphz-silver rounded-full"
                />
              </div>

              <div className="group">
                <div className="flex justify-between items-center mb-6">
                  <label className="text-[10px] font-mono text-neutral-400 uppercase tracking-[0.3em] font-bold">Operations Horizon (Years)</label>
                  <span className="text-2xl font-bold text-emphz-blue">{years} <span className="text-neutral-400 text-sm">YRS</span></span>
                </div>
                <input
          ...
          <div className="lg:w-3/5">
            <div className="bg-white rounded-[3.5rem] p-12 md:p-16 shadow-[0_40px_100px_-30px_rgba(0,0,0,0.08)] border border-neutral-50 relative overflow-hidden h-full flex flex-col">
              <div className="flex flex-col md:flex-row gap-10 items-end justify-between mb-16">
                <div className="text-left">
                  <p className="text-neutral-400 font-mono text-[9px] uppercase tracking-[0.4em] mb-3 font-bold">Projected Net Savings</p>
              ...
              <div className="space-y-10 flex-grow">
                <div className="group">
                  <div className="flex justify-between text-[10px] font-mono uppercase tracking-widest font-bold text-neutral-400 mb-4">
                    <span>EMPHZ GRP Systems</span>
                    <span className="text-emphz-blue">${grpTotal.toLocaleString()}</span>
                  </div>
                  <div className="h-4 bg-neutral-50 rounded-full relative overflow-hidden border border-neutral-100">
                    <div
                ...
                <div className="group">
                  ...
                  <div className="h-4 bg-neutral-50 rounded-full relative overflow-hidden border border-neutral-100">
                    <div
                      className="h-full bg-neutral-400 transition-all duration-1000 ease-out"
              ...
              <div className="mt-16 grid grid-cols-2 gap-10 pt-12 border-t border-neutral-100">
                <div className="flex gap-5">
                  ...
                  <p className="text-[11px] text-neutral-400 uppercase tracking-widest font-bold leading-relaxed">Zero Surface Refinishing Over Lifetime</p>
                </div>
                <div className="flex gap-5">
                  <div className="w-12 h-12 rounded-2xl bg-emphz-silver/10 flex items-center justify-center text-emphz-blue shrink-0">
                    <Activity className="w-6 h-6" />
                  </div>
                  <p className="text-[11px] text-neutral-400 uppercase tracking-widest font-bold leading-relaxed">Integrated Thermal Performance Advantage</p>
                </div>
              </div>
            </div>
          </div>
