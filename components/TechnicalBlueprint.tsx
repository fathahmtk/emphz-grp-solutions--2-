    ...
    <section id="blueprints" className="py-24 bg-emphz-darker relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-20 gap-12">
          <SectionHeader
            number="17"
            category="SCHEMATIC VAULT"
            title="Industrial Schematic Protocol"
            subtitle="Precision CAD schematics engineered for seamless mechanical integration. Native .DXF and .STEP blocks available for structural verification."
          />
