      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col lg:flex-row gap-16 items-stretch">
          ...
          <div className="lg:w-2/5 flex flex-col">
            <div className="flex-grow bg-slate-50 rounded-[3rem] overflow-hidden shadow-xl border border-slate-100 flex flex-col">
              ...
              <div className="p-10 flex-grow">
                ...
                <div>
                  <p className="font-mono text-[10px] text-slate-400 uppercase tracking-widest mb-6">Select Facility</p>
                    ...
                    {OFFICES.map((office) => (
                      <button
                        ...
                        className={`px-6 py-3 rounded-full text-[10px] font-bold tracking-widest uppercase transition-all border ${activeOffice.id === office.id
                          ...
                          : 'bg-white text-slate-400 border-slate-200 hover:border-emphz-blue'
                          }`}
                      >
                        {office.name.split(' ')[0]}
                      </button>
                ...
                <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest px-1">Full Name</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest px-1">Organization</label>
                      <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest px-1">Email Address</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest px-1">Project Details</label>
                  ...
                  <button type="submit" className="w-full bg-emphz-silver text-emphz-blue rounded-full font-bold py-6 mt-4 tracking-[0.3em] uppercase transition-all flex items-center justify-center gap-4 group hover:bg-white shadow-2xl shadow-slate-700/20">
