...
import { Plus, Minus, MessageCircle, FileText } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="space-y-6">
          {FAQS.map((faq, idx) => (
            <div
              key={idx}
              className={`rounded-[2rem] transition-all duration-700 border ${openIndex === idx
            ...
            >
              ...
              >
                <div className="flex gap-6 items-center">
                  ...
                  <span className={`font-bold text-lg md:text-xl pr-8 transition-colors tracking-tight uppercase ${openIndex === idx ? 'text-emphz-darker' : 'text-neutral-500 group-hover:text-emphz-darker'
                    }`}>
                    {faq.q}
                  </span>
                </div>
