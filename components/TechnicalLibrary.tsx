...
import { Search, FileText, Download, FileCode, CheckCircle2 } from 'lucide-react';
...
const TechnicalLibrary: React.FC = () => {
   ...
   return (
      <section id="library" className="py-24 md:py-32 bg-neutral-50 text-emphz-darker relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-24 gap-12">
               ...
               <div className="relative w-full lg:w-[450px]">
                  <div className="bg-white p-2 rounded-full shadow-2xl border border-neutral-100 flex items-center">
                     ...
                     <input
                        ...
                        className="flex-grow bg-transparent px-6 py-4 text-[10px] font-mono font-bold text-emphz-darker placeholder:text-neutral-300 focus:outline-none uppercase tracking-widest"
                     />
                  </div>
               </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3 mb-16">
               {categories.map(tab => (
                  <button
                     ...
                     className={`px-10 py-4 text-[10px] font-bold uppercase tracking-widest rounded-full transition-all duration-500 border ${activeTab === tab
                           ? 'bg-emphz-teal text-white border-emphz-teal shadow-xl shadow-emphz-teal/20 scale-105'
                           : 'bg-white text-neutral-400 border-neutral-200 hover:border-emphz-teal hover:text-emphz-teal'
                        }`}
                  >
                     {tab}
                  </button>
                  ...
                  <div key={doc.id} className="group bg-white p-10 rounded-[3rem] shadow-[0_40px_100px_-30px_rgba(0,0,0,0.05)] hover:-translate-y-3 transition-all duration-700 border border-neutral-50 flex flex-col h-[380px]">
                     <div className="flex justify-between items-start mb-10">
                        ...
                        <div className="text-right">
                           <span className="block text-[9px] font-mono text-neutral-300 uppercase tracking-widest font-bold">TYPE_REF</span>
                     ...
                     <div className="flex-grow">
                        <div className="flex items-center gap-2 mb-4">
                           ...
                           <span className="text-[9px] font-mono text-neutral-400 uppercase tracking-widest font-bold">Ref: {doc.id}</span>
                        </div>
                        ...
                        <p className="text-[10px] text-neutral-400 font-mono uppercase tracking-[0.2em] font-bold">System Category: {doc.category}</p>
                     </div>
            ...
            {filtered.length === 0 && (
               <div className="text-center py-20 bg-white rounded-[3rem] border border-dashed border-neutral-200">
                  <p className="text-neutral-400 font-mono text-sm uppercase tracking-widest">No matching engineering assets found.</p>
               </div>
            )}
         </div>
      </section>
