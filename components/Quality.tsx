      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
          <SectionHeader
            number="10"
            category="Standards"
            title="Compliance & Safety Matrix"
            subtitle="Industrial-grade certification and rigorous stress testing protocols ensure structural integrity across high-risk zones."
          />
          <div className="md:text-right pb-10">
