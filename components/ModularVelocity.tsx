      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative">
            <div className="flex justify-between items-end mb-6">
              ...
              <div className="text-right">
                ...
                <span className="text-slate-500 font-mono ml-2 uppercase text-xs">Days Elapsed</span>
              </div>
            </div>
            ...
            <div className="h-4 bg-white/5 border border-white/10 relative overflow-hidden">
              ...
              {milestones.map((m, i) => (
                ...
                >
                  <div className={`absolute -bottom-10 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] font-mono uppercase tracking-widest transition-opacity duration-500 ${progress >= (m.day / 6) * 100 ? 'text-emphz-teal opacity-100' : 'text-slate-600 opacity-40'}`}>
          ...
          <div className="relative opacity-60 grayscale">
            <div className="flex justify-between items-end mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-300 uppercase tracking-wider">TRADITIONAL CIVIL</h3>
                  <p className="text-slate-500 font-mono text-xs uppercase">On-Site Fabrication</p>
                </div>
              </div>
              <div className="text-right">
                <span className="text-4xl font-bold text-slate-500 font-mono">{Math.floor((progress / 100) * 45)}</span>
                <span className="text-slate-500 font-mono ml-2 uppercase text-xs">Days Elapsed</span>
              </div>
            </div>
            ...
            <div className="h-4 bg-white/5 border border-white/10 relative">
              ...
              {milestones.map((m, i) => (
                ...
                >
                  <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] font-mono uppercase tracking-widest text-slate-600">
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
           <div className="bg-emphz-darker p-8 border border-white/10 hover:border-emphz-teal/30 transition-colors">
              ...
              <p className="text-sm text-slate-400">All components manufactured under controlled environments, eliminating weather delays and site wastage.</p>
           </div>
           <div className="bg-emphz-darker p-8 border border-white/10 hover:border-emphz-teal/30 transition-colors">
              <FastForward className="w-8 h-8 text-emphz-teal mb-4" />
              <h4 className="text-white font-bold mb-2">PLUG & PLAY</h4>
              <p className="text-sm text-slate-400">Integrated electrical and plumbing channels allow for "Last-Mile" commissioning within hours of delivery.</p>
           </div>
           <div className="bg-emphz-darker p-8 border border-white/10 hover:border-emphz-teal/30 transition-colors">
              <Calendar className="w-8 h-8 text-emphz-teal mb-4" />
              <h4 className="text-white font-bold mb-2">FIXED COST</h4>
              <p className="text-sm text-slate-400">No time-overruns or material price fluctuations. Project costs are locked at the design stage.</p>
           </div>
        </div>
      </div>
    </section>
