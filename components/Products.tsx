          ...
          {filtered.map((product) => (
            ...
            >
              <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden mb-10 shadow-xl shrink-0">
                ...
                <div className="absolute top-8 left-8 w-16 h-16 bg-white rounded-full shadow-2xl flex items-center justify-center text-emphz-blue border border-neutral-50">
                  {product.icon}
                </div>
              </div>
