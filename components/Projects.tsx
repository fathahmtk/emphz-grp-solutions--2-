    ...
    <section id="projects" className="py-24 bg-emphz-dark relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
           <div>
             <span className="font-mono text-emphz-teal text-xs tracking-widest uppercase mb-4 block">07 / Case Studies</span>
             <h2 className="text-4xl font-bold text-white">DEPLOYMENT LOG</h2>
           </div>
