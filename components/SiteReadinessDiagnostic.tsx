             ...
             <div className="space-y-10">
                <div className="group">
                  <div className="flex justify-between mb-4 items-end">
                    <div className="flex items-center gap-3">
                       ...
                       <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold">Proximity to Coast</label>
                    </div>
                  ...
                  <input 
                    ...
                    className="w-full h-1.5 bg-slate-100 appearance-none cursor-pointer accent-emphz-silver rounded-full"
                  />
                </div>
                ...
                <div className="group">
                  <div className="flex justify-between mb-4 items-end">
                    <div className="flex items-center gap-3">
                       ...
                       <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold">Peak Wind Velocity</label>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-8">
                   <div className="space-y-4">
                      <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold block">Chemical Exposure</label>
                      <select 
                        value={params.chemicalExposure}
                        onChange={(e) => setParams({...params, chemicalExposure: e.target.value})}
                        className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 text-xs font-bold uppercase tracking-widest outline-none focus:border-emphz-blue transition-all"
                      >
                   ...
                   <div className="space-y-4">
                      <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold block">Peak Temperature</label>
          ...
          <div className="lg:w-1/2">
             <div className="bg-emphz-blue rounded-[4rem] p-12 md:p-20 shadow-2xl relative overflow-hidden h-full flex flex-col justify-between">
                ...
                <div className="relative z-10 text-center mb-16">
                   ...
                   <p className="text-slate-500 font-mono text-[9px] uppercase tracking-widest mt-6">Relative Integrity over 15-Year Cycle</p>
                </div>
                ...
                <div className="relative z-10 grid grid-cols-2 gap-4 mt-10 pt-10 border-t border-white/5">
                   <div className="text-center">
                      ...
                      <span className="text-[8px] font-mono text-slate-500 uppercase tracking-widest">Resin Category</span>
                   </div>
                   <div className="text-center">
                      <span className="block text-white font-bold text-lg tracking-tight">VETTED</span>
                      <span className="text-[8px] font-mono text-slate-500 uppercase tracking-widest">Procurement Status</span>
                   </div>
                </div>
             </div>
          </div>
