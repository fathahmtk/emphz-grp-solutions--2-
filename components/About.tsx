...
const About: React.FC = () => {
  return (
    <section id="about" className="py-24 md:py-32 bg-slate-50 text-emphz-blue relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          <div className="lg:w-1/2 relative">
            <div className="grid grid-cols-2 gap-6 items-end">
               <div className="space-y-6">
                  <div className="aspect-[4/5] bg-slate-200 rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white group relative">
               ...
               <div className="space-y-6">
                  <div className="aspect-square bg-slate-200 rounded-full overflow-hidden shadow-2xl border-8 border-white group relative cursor-pointer">
                  ...
                  <div className="aspect-[4/5] bg-slate-200 rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="bg-white p-10 rounded-[3rem] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.1)] border border-slate-100 flex flex-col md:flex-row gap-10 items-center">
               ...
               <div className="flex-grow text-center md:text-left">
                 <p className="text-slate-400 text-[10px] font-bold tracking-[0.3em] uppercase mb-2">FOR MORE INFORMATION, PLEASE</p>
                 <h4 className="text-2xl font-bold text-emphz-blue tracking-tight mb-4">Contact Us By Telephone Or Email</h4>
                 
                 <div className="flex flex-col md:flex-row gap-6 md:items-center">
                    <span className="text-2xl font-bold text-emphz-blue tracking-tighter hover:text-slate-500 transition-colors cursor-pointer">+91 9037 874 080</span>
                    <a href="mailto:info@emphz.in" className="bg-emphz-silver text-emphz-blue px-8 py-3 rounded-full text-[10px] font-bold tracking-[0.2em] hover:bg-emphz-blue hover:text-white transition-all uppercase flex items-center gap-2 shadow-lg shadow-slate-300">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 md:gap-16">
               <div className="flex items-start gap-4">
                 ...
                 <div>
                   ...
                   <span className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold">Year Design Life</span>
                 </div>
               </div>
               <div className="flex items-start gap-4">
                 <CheckCircle2 className="w-6 h-6 text-emphz-blue shrink-0" />
                 <div>
                   ...
                   <span className="text-[10px] font-mono text-slate-500 uppercase tracking-widest font-bold">Protection Grade</span>
                 </div>
               </div>
            </div>
          </div>
