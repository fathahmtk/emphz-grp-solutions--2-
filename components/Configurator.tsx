...
import { Settings, Ruler, Shield, Box, ArrowRight, CheckCircle2, PlusCircle } from 'lucide-react';
              ...
              {step === 4 && (
                <div className="space-y-6">
                  ...
                  <div className="pt-8 border-t border-white/5">
                    <button 
                      onClick={handleAdd}
                      className={`w-full py-5 font-bold uppercase tracking-widest text-xs transition-all flex items-center justify-center gap-3 shadow-lg rounded-full ${
                        isAdded 
