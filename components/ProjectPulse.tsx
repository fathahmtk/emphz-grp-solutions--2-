    ...
    <section className="py-24 bg-white border-t border-slate-100 relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="group bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100 hover:shadow-2xl transition-all duration-500">
             ...
             <div className="mb-10">
                ...
                <span className="block text-[10px] font-mono text-slate-400 mt-4 uppercase tracking-widest">Units / Shift</span>
             </div>
          ...
          <div className="group bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100 hover:shadow-2xl transition-all duration-500">
             <div className="flex items-center gap-3 text-slate-400 font-mono text-[9px] font-bold uppercase tracking-widest mb-10">
             ...
             <div className="mb-10">
                ...
                <span className="block text-[10px] font-mono text-slate-400 mt-4 uppercase tracking-widest">Global Deployments</span>
             </div>
             <div className="flex gap-1.5">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className={`h-1 flex-1 rounded-full ${i < 4 ? 'bg-emphz-teal' : 'bg-slate-200'}`}></div>
                ))}
             </div>
          </div>
          ...
          <div className="group bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100 hover:shadow-2xl transition-all duration-500">
             ...
             <div className="mb-10">
                ...
                <span className="block text-[10px] font-mono text-slate-400 mt-4 uppercase tracking-widest">Tons Processed / YTD</span>
             </div>
             <div className="flex items-center gap-2 font-mono text-[8px] text-slate-300 uppercase">
