      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full pt-32 pb-48 relative z-20">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-8">
          ...
          <div className="lg:w-3/5 text-center lg:text-left">
            ...
            <p className="text-slate-300 text-lg md:text-xl max-w-xl mb-12 leading-relaxed font-light opacity-90 mx-auto lg:mx-0">
            ...
            <div className="mt-16 inline-flex flex-col md:flex-row items-center gap-8 md:gap-12 p-8 bg-white backdrop-blur-2xl rounded-[2rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] border border-white/10 group">
               <div className="text-left px-4">
                  <span className="block text-[9px] font-mono text-slate-400 uppercase tracking-widest mb-1">Design Life From</span>
                  <div className="flex items-baseline">
                    <span className="text-3xl font-bold text-emphz-blue">50</span>
                    <span className="text-slate-400 text-sm font-bold ml-1 tracking-widest">+ YEARS</span>
                  </div>
               </div>
               ...
               <div className="text-left px-4">
                  ...
                  <span className="block text-[9px] font-mono text-slate-400 uppercase tracking-widest">Industry Ranking</span>
